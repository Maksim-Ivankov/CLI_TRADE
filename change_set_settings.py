...
class Strat_gen:
    def __init__(self,settings):
        ...
        self.HOW_MACH_SET = '50' # размер сета нсатроек
    ...
    def generate_to_file(self):
        ...
        str_settings=f'{self.CANAL_MAX_gen},{self.CANAL_MIN_gen},{self.VALUE_TRADE_MIN_gen},{self.VALUE_TRADE_MAKS_gen},{self.TP_gen},{self.SL_gen}'

        f = open(self.settings['set_strat_1'],'a',encoding='utf-8')
        f.write('\n'+str_settings)
        f.close()
